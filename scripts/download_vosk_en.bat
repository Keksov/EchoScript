...
"%VENV_DIR%\Scripts\python.exe" "%SCRIPT_DIR%download_vosk_model.py" --hf-repo "Derur/vosk-models" --hf-path "punctuation/vosk-recasepunc-en-0.22" --target-root "%VOSK_MODELS_ROOT%" --expected-dir "vosk-recasepunc-en-0.22"
if errorlevel 1 (
...
"%VENV_DIR%\Scripts\python.exe" "%SCRIPT_DIR%prefetch_hf_model.py" --model-id "bert-base-uncased"
if errorlevel 1 (
