...
"%VENV_DIR%\Scripts\python.exe" "%SCRIPT_DIR%..\..\..\scripts\download_vosk_model.py" --url "https://alphacephei.com/vosk/models/vosk-model-small-ru-0.22.zip" --target-root "%VOSK_MODELS_ROOT%" --expected-dir "vosk-model-small-ru-0.22"
if errorlevel 1 (
