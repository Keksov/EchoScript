@echo off
REM ============================================================
REM EchoScript - Download: DiarizationDaemon sherpa assets
REM Downloads:
...
set "TARGET_RUNTIME_DIR=services\diarizationdaemon\sherpa\vendors\sherpa-onnx"
set "TARGET_MODELS_DIR=services\diarizationdaemon\sherpa\models"
...
set "TMP_DIR=services\diarizationdaemon\sherpa\build\_tmp_diarize_download"
...
echo.
echo [OK] DiarizationDaemon sherpa assets are ready.
